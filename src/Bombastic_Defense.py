...
ROGUE_ITEMS = [
    # ── PASSIVE BUFFS ────────────────────────────────────────────────────────
    {
        "id": "gold_rush",
        "name": "Gold Rush",
        "icon": "item_gold_rush.png", # Not in Files !!!! TODO: add this icon
        "emoji": "💰",
    ...
    },
    {
        "id": "warlords_drum",
        "name": "Warlord's Drum",
        "icon": "item_drum.png", # Not in Files !!!! TODO: add this icon
        "emoji": "🥁",
    ...
    },
    {
        "id": "sniper_scope",
        "name": "Master Scope",
        "icon": "item_scope.png", # Not in Files !!!! TODO: add this icon
        "emoji": "🔭",
    ...
    },
    {
        "id": "bomb_upgrade",
        "name": "Big Charges",
        "icon": "item_bigbomb.png", # Not in Files !!!! TODO: add this icon
        "emoji": "💣",
    ...
    },
    {
        "id": "pulse_emp",
        "name": "EMP Capacitor",
        "icon": "item_emp.png", # Not in Files !!!! TODO: add this icon
        "emoji": "⚡",
    ...
    },
    {
        "id": "iron_skin",
        "name": "Iron Skin",
        "icon": "item_ironskin.png", # Not in Files !!!! TODO: add this icon
        "emoji": "🛡",
    ...
    },
    {
        "id": "double_interest",
        "name": "Bull Market",
        "icon": "item_bull.png", # Not in Files !!!! TODO: add this icon
        "emoji": "📈",
    ...
    },
    {
        "id": "mud_overflow",
        "name": "Toxic Spill",
        "icon": "item_toxic.png", # Not in Files !!!! TODO: add this icon
        "emoji": "☠️",
    ...
    },
{
        "id": "crystal_heart",
        "name": "Crystal Heart",
        "icon": "item_heart.png", # Not in Files !!!! TODO: add this icon
        "emoji": "💎",
    ...
    },
    {
        "id": "tower_overcharge",
        "name": "Overcharge",
        "icon": "item_overcharge.png", # Not in Files !!!! TODO: add this icon
        "emoji": "🔋",
    ...
    },
    {
        "id": "ghost_rounds",
        "name": "Ghost Rounds", 
        "icon": "item_ghost.png", # Not in Files !!!! TODO: add this icon
        "emoji": "👻",
    ...
    },
    {
        "id": "mine_cache",
        "name": "Mine Cache",
        "icon": "item_minecache.png", # Not in Files !!!! TODO: add this icon
        "emoji": "🪤",
    ...
    },
    {
        "id": "berserker_drum",
        "name": "Berserker Drum",
        "icon": "item_berserk.png", # Not in Files !!!! TODO: add this icon
        "emoji": "🥁",
...
ROGUE_TOWERS = [
    {
        "id": "nail_pile",
        "name": "Nail Pile",
        "icon": "item_nails.png", # Not in Files !!!! TODO: add this icon
        "emoji": "📌",
    ...
    },
    {
        "id": "oracle",
        "name": "Oracle Beacon",
        "icon": "item_oracle.png", # Not in Files !!!! TODO: add this icon
        "emoji": "🔮",
    ...
    },
    {
        "id": "aura_forge",
        "name": "Aura Forge",
        "icon": "item_forge.png", # Not in Files !!!! TODO: add this icon
        "emoji": "⚒️",
...
class Tower(UpgradableMixin):
    def __init__(self, canvas, sprite, bullet_img):
        self.canvas       = canvas
        self.sprite       = sprite
        self.base_pil_img = Image.open(os.path.join(os.path.dirname(__file__), "Images", "Enteties", "Towers", "tower.png"))
...
class BombTower(UpgradableMixin):
    def __init__(self, canvas, x, y, tower_img, bomb_img):
        ...
        self.placement_radius = 5
        self.base_pil_img = Image.open(os.path.join(os.path.dirname(__file__), "Images", "Enteties", "Towers", "bomber.png"))
        self.tk_img       = ImageTk.PhotoImage(self.base_pil_img)
        self.sleeping     = False
        self.sleep_overlay = None
        self.range        = 130
...
class SniperTower(UpgradableMixin):
    def __init__(self, canvas, x, y):
        self.canvas       = canvas
        self.base_pil_img = Image.open(os.path.join(os.path.dirname(__file__), "Images", "Enteties", "Towers", "sniper.png"))
        self.tk_img       = ImageTk.PhotoImage(self.base_pil_img)
...
class Game:
    ...
    def show_difficulty_menu(self, map_key):
        ...
        for col, (key, cfg) in enumerate(DIFFICULTIES.items()):
            ...
            btn_out  = cfg["color"]
            c.create_rectangle(cx + 20, bcy, cx + card_w - 20, bcy + 40, fill=btn_fill, outline=btn_out, width=2)
    ...
    def start_game(self, map_key, difficulty_key):
        ...
        self.canvas = Canvas(self.game_frame, width=1100, height=700, bg="#1a1a2e", highlightthickness=0)
        ...
        # Note: the folder under Images is named 'Enteties' (typo in repo)
        ENT_DIR = os.path.join(ASSET_DIR, "Enteties")

        self.enemy_img        = PhotoImage(file=os.path.join(ENT_DIR, "Bloons", "Baloon.png"))
        self.tower_img        = PhotoImage(file=os.path.join(ENT_DIR, "Towers", "tower.png"))
        self.bullet_img       = PhotoImage(file=os.path.join(ENT_DIR, "Towers", "Bullet.png"))
        self.barricade_img    = PhotoImage(file=os.path.join(ENT_DIR, "Towers", "barrikade.png"))
        self.star_img         = PhotoImage(file=os.path.join(ENT_DIR, "Bloons", "stern.png"))
        self.nuke_img         = PhotoImage(file=os.path.join(ENT_DIR, "Bloons", "nuclear_baloon.png"))
        self.blue_img         = PhotoImage(file=os.path.join(ENT_DIR, "Bloons", "BlueBaloon.png"))
        self.yellow_img       = PhotoImage(file=os.path.join(ENT_DIR, "Bloons", "YellowBaloon.png"))
        self.bombtower_img    = PhotoImage(file=os.path.join(ENT_DIR, "Towers", "bomber.png"))
        self.bomb_img         = PhotoImage(file=os.path.join(ENT_DIR, "Towers", "bomb.png"))
        self.gunner_img       = PhotoImage(file=os.path.join(ENT_DIR, "Towers", "Gunner.png"))
        self.bank_img         = PhotoImage(file=os.path.join(ENT_DIR, "Towers", "money.png"))
        self.armored_img      = PhotoImage(file=os.path.join(ENT_DIR, "Bloons", "armored_baloon.png"))
        self.shield_img       = PhotoImage(file=os.path.join(ENT_DIR, "Bloons", "Shield.png"))
        self.shield_break_img = PhotoImage(file=os.path.join(ENT_DIR, "Bloons", "shield_breaks.png"))
        self.boss_stage1      = PhotoImage(file=os.path.join(ENT_DIR, "Bosses", "Boss1_stage1.png"))
        self.boss_stage2      = PhotoImage(file=os.path.join(ENT_DIR, "Bosses", "Boss1_stage2.png"))
        self.boss_stage3      = PhotoImage(file=os.path.join(ENT_DIR, "Bosses", "Boss1_stage3.png"))
        self.sniper_img       = PhotoImage(file=os.path.join(ENT_DIR, "Towers", "sniper.png"))
        self.sniper_bullet_img = PhotoImage(file=os.path.join(ENT_DIR, "Towers", "sniper_bullet.png"))
        self.mark_img         = PhotoImage(file=os.path.join(ENT_DIR, "Towers", "mark.png"))
        self.zeppelin_img     = {
            "L": PhotoImage(file=os.path.join(ENT_DIR, "Bosses", "Zeppelin1_L.png")),
            "R": PhotoImage(file=os.path.join(ENT_DIR, "Bosses", "Zeppelin1_R.png")),
            "U": PhotoImage(file=os.path.join(ENT_DIR, "Bosses", "Zeppelin1_U.png")),
            "D": PhotoImage(file=os.path.join(ENT_DIR, "Bosses", "Zeppelin1_D.png")),
        }
        self.juggernaut_img = PhotoImage(file=os.path.join(ENT_DIR, "Bloons", "juggernaut.png"))
        self.phase_runner_img = PhotoImage(file=os.path.join(ENT_DIR, "Bloons", "phase_runner.png"))
        self.regenerator_img = PhotoImage(file=os.path.join(ENT_DIR, "Bloons", "regenerator.png"))
        self.bomber_drone_img = PhotoImage(file=os.path.join(ENT_DIR, "Bloons", "bomber_drone.png"))
        self.shielded_brute_img = PhotoImage(file=os.path.join(ENT_DIR, "Bloons", "shielded_brute.png"))

        try:
            self.shadow_img = PhotoImage(file=os.path.join(ENT_DIR, "Bloons", "Shadow.png"))
        except Exception:
            self.shadow_img = self.blue_img

        self.balloon_pop_sounds   = [pygame.mixer.Sound(os.path.join(SOUND_DIR, f"balloonPop{i}.mp3")) for i in range(1,5)]
        ...
        self.pause_overlay = self.canvas.create_rectangle(0, 0, 1200, 820, fill="black", stipple="gray50", state="hidden")
        self.pause_text = self.canvas.create_text(550, 350, text="⏸  PAUSED", fill="white", font=("Courier", 32, "bold"), state="hidden")
